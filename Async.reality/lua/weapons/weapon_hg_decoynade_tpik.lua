...
SWEP.Instructions =
[[A distraction device that imitates Glock fire for 15 seconds after activation.
...
SWEP.WorldModelReal = "models/weapons/zcity/c_m84.mdl"
