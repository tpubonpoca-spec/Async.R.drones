--[[
    ...
    Включение/выключение в консоли: async_drone_debug 1 / 0
--]]
...
if CLIENT then
    ...
    hook.Add("CalcView", "zzzz_LVS_Drone_Debug_CalcView", function(ply, pos, angles, fov)
        ...
        debug_info.last_hook = "zzzz_LVS_Drone_Debug_CalcView"
    ...
    hook.Add("HUDPaint", "zzzz_LVS_Drone_Debug_HUD", function()
