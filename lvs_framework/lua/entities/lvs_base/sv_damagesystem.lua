...
function ENT:Explode()
	...
	if IsValid( Driver ) then
		local isDrone = self.LVSUAV or self.IsDrone or self.IsCrocusKamikaze or self.IsKVNDrone or (self:GetClass() and (self:GetClass():lower():find("crocus") or self:GetClass():lower():find("kvn") or self:GetClass():lower():find("drone") or self:GetClass():lower():find("uav")))
		if not isDrone then
