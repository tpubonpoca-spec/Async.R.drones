...
function meta:lvsMouseAim()
	...
	local veh = self:lvsGetVehicle()
	if IsValid( veh ) and ( veh.LVSUAV or veh.IsDrone or veh.IsCrocusKamikaze or veh.IsKVNDrone or ( veh:GetClass() and ( veh:GetClass():lower():find("crocus") or veh:GetClass():lower():find("kvn") or veh:GetClass():lower():find("drone") ) ) ) then
		return true
	end
